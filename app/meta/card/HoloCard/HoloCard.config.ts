...
export const holoCardConfig: ComponentConfig = {
  ...
  containerClassName: "w-full min-h-[500px] !h-auto flex items-center justify-center bg-[#060010] rounded-[18px] border border-white/5 p-12 overflow-hidden",
  props: [
    {
      name: "image",
      type: "string",
      default: "https://images.unsplash.com/photo-1674849555293-9ef7e42f9048?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2Nzc1ODAxODY&ixlib=rb-4.0.3&q=80",

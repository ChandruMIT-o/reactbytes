...
export const VelvetNoise: React.FC<VelvetNoiseProps> = ({
  ...
  // Use refs for the animation loop to access latest state without rebuilding program
  ...
  // Track state changes in refs instantly
  useEffect(() => {
    paramsRef.current = {
      cells,
      stripes,
  ...
  useEffect(() => {
    ...
    const render = (now: number) => {
      ...
      // Handle Resize dynamically based on DOM sizes & DPR scale
      resizeCanvas();

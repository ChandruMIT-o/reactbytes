...
export const petalWaveConfig: ComponentConfig = {
  ...
  npmPackageName: "@reactbytes/petal-wave",
  version: "1.0.0",
  description: "A highly performant organic SVG grid background morphing component animated with GSAP.",
  dependencies: {},
  peerDependencies: {
    react: "^18.0.0",
  },
  ...
  props: [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "hexagon", label: "Hexagon Lattice" },
        { id: "droplet", label: "Droplet Wave" },
        { id: "kite", label: "Kite Pattern" },
      ],

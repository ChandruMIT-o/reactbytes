            ...
            {open && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed left-1/2 top-[12vh] z-[101] w-full max-w-[420px] -translate-x-1/2 rounded-2xl border border-white/8 bg-rb-neutral-2 shadow-2xl overflow-hidden"
                  role="dialog"
                  aria-modal="true"
                ...
                >
                  ...
                  >
                    ...
                    {showEmpty && (
                      <div className="px-4 py-10 text-center">
                        <div className="text-rb-accent-2/30 text-[13px] tracking-wide">
                          No components match{" "}
                        ...
                        <ul ref={listRef} role="listbox" className="py-2">
                          {displayList.map((result, i) => (
                            <li
                              ...
                              className={`flex items-center gap-3 mx-2 px-3 py-2.5 rounded-xl cursor-pointer transition-colors duration-100 ${
                                i === activeIndex
                                  ? "bg-rb-neutral-4"
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-1.5 mt-0.5">
                                  <span className="text-rb-accent-2/30 text-[12px]">
                  ...
                  {/* Footer hint */}
                  <div className="flex items-center justify-between px-4 py-2.5 border-t border-white/5 text-rb-accent-2/20 text-[11px] font-sans gap-4">
                    ...
                    <span className="text-rb-accent-2/15">
                      {isSearching
                        ? "Searching…"
                        : query.trim()

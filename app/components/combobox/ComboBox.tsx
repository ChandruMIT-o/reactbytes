	...
	return (
		...
		>
			...
			<div className="group relative">
				...
				>
					{/* Inner Input Area */}
					<div className="bg-rb-neutral-1 rounded-[16px] border border-rb-neutral-4 flex items-center px-4 py-3 gap-3 overflow-hidden">
						<Search
							size={18}
				...
				<AnimatePresence>
					{isOpen && (
						<motion.div
							...
							className="absolute top-full left-0 right-0 z-[999] bg-rb-neutral-3 p-1.5 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-rb-neutral-4/30"
						>

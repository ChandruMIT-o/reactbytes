...
export default function LeftSidebarMenu() {
	...
	return (
		<div className="min-h-screen p-10 flex font-sans selection:bg-[#F2EEE9] selection:text-[#060010]">
			<div className="relative w-56 flex flex-col">
				...
				<div className="relative z-10 mb-3 ml-[20px]">
					<button className="w-6 h-6 bg-[#F2EEE9] hover:bg-white transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-110 hover:-rotate-6 active:scale-90 rounded-[7px] flex items-center justify-center shadow-sm">
						<svg
							viewBox="0 0 24 24"
							fill="currentColor"
				...
				>
					...
					<AnimatePresence>
						{hoveredItemId && (
							<motion.div
								...
								className="absolute left-[18px] -right-[18px] h-[44px] bg-[#1D1C21] rounded-xl z-0 pointer-events-none shadow-xl shadow-black/20"
							>
								{/* Hover Pill (Left) */}
								<motion.div
					...
					<motion.div
						...
						transition={springConfig}
						className="absolute left-[18px] -right-[18px] h-[44px] bg-[#F2EEE9] rounded-xl z-10 pointer-events-none shadow-md shadow-black/10"
					>
						{/* Active Pill (Left) */}
					...
					{navItems.map((item) => {
						...
						return (
							<button
								...
								className="group relative ml-[18px] flex h-[44px] w-full items-center justify-between px-[10px] rounded-xl outline-none focus-visible:ring-2 focus-visible:ring-[#F2EEE9]/50 active:scale-[0.98] transition-all cursor-pointer duration-200 z-20"
							>

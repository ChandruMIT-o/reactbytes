        ...
        <div className="bg-rb-neutral-1 rounded-[18px] w-full min-h-[400px] border border-rb-neutral-4 overflow-hidden relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit={{ opacity: 0, y: -12, filter: "blur(12px)", scale: 0.99 }}
            ...
            >
              {activeTab === "preview" ? (
                <>
                  <div
                    className={`w-full h-full min-h-[400px] flex items-center justify-center transition-all duration-500 ${previewMode !== "desktop" ? "bg-rb-neutral-2 canvas-grid" : ""}`}
                  >
                    <div
        ...
        {(children || header) && (
          <div className="mt-1.5 px-3 py-3 bg-rb-neutral-1 rounded-[18px] border border-rb-neutral-4 flex flex-col gap-3">
            <div className="flex items-center justify-between gap-2 relative z-50">
              <div className="flex-1 preview-tab-header">{header}</div>
              {collapsible && (
                <button

...
export const PropsTable: React.FC<PropsTableProps> = ({
	...
	return (
		<div className={`w-full font-sans ${className}`}>
			...
			<div className="bg-rb-neutral-3 p-1 md:p-1.5 rounded-[20px] md:rounded-[24px] w-full relative">
				{/* Actual Content Area */}
				<div className="bg-rb-neutral-1 rounded-[16px] md:rounded-[18px] w-full overflow-hidden border border-rb-neutral-4">
					<div className="overflow-x-auto scrollbar-thin">
						<table className="w-full min-w-[900px] text-left text-[14px] text-rb-accent-2/60 border-collapse">
							{/* Table Header */}
									...
									<React.Fragment key={category.title}>
										...
										<tr className="bg-rb-neutral-4/30">
											<td colSpan={4} className="px-6 py-2.5">
												<span className="text-[10px] md:text-xs font-bold uppercase tracking-[0.1em] text-rb-accent-1/50">
													{category.title}
												</span>
											</td>
										</tr>

  ...
  return (
    <div className="flex flex-col h-[100dvh] overflow-hidden font-sans bg-background text-foreground transition-colors duration-500">
      ...
      <div className="flex flex-1 overflow-hidden w-full max-w-[100vw] justify-between md:px-2 md:py-3 relative">
        ...
        {/* Left Sidebar */}
        <aside
          className={`fixed inset-y-0 left-0 z-[70] w-[280px] max-w-[90vw] bg-rb-neutral-2 border-r border-white/5 md:bg-transparent md:border-none md:relative md:w-auto h-full flex flex-col transform transition-transform duration-300 ease-in-out ${
            isMobileMenuOpen
              ? "translate-x-0"

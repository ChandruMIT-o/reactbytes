...
const DownloadPanel: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between py-3 px-3 relative bg-transparent">
      <div className="flex items-center justify-between border-b border-white/5 pb-3 text-sm font-mono text-[#e6dff1]/70">
      ...
      <div className="flex flex-col gap-4 flex-grow justify-center py-4 px-1">
        {/* Simple visual tabs */}
        <div className="flex gap-3 border-b border-white/5 pb-3 font-mono text-xs">
          <span className={`px-2.5 py-1 rounded cursor-pointer transition-colors duration-200 ${activeTab === 'cli' ? 'bg-[#c0dedd]/10 text-[#c0dedd]' : 'text-[#e6dff1]/40'}`}>CLI</span>
          <span className={`px-2.5 py-1 rounded cursor-pointer transition-colors duration-200 ${activeTab === 'npm' ? 'bg-[#c0dedd]/10 text-[#c0dedd]' : 'text-[#e6dff1]/40'}`}>NPM</span>
          <span className={`px-2.5 py-1 rounded cursor-pointer transition-colors duration-200 ${activeTab === 'mcp' ? 'bg-[#c0dedd]/10 text-[#c0dedd]' : 'text-[#e6dff1]/40'}`}>MCP</span>
        </div>

        <div className="bg-[#181a1e]/40 border border-white/5 rounded-lg p-4 font-mono text-sm text-[#e6dff1]/80 h-20 flex items-center justify-between">
          {activeTab === 'cli' && (
            <>
              <span className="text-[#e6dff1]/90 select-all">npx reactbytes add ripple</span>
              <Terminal size={18} className="text-[#e6dff1]/40" />
            </>
          )}
          {activeTab === 'npm' && (
            <>
              <span className="text-[#e6dff1]/90 select-all">npm i @reactbytes/ripple</span>
              <Box size={18} className="text-[#e6dff1]/40" />
            </>
          )}
          {activeTab === 'mcp' && (
            <>
              <span className="text-[#e6dff1]/90 select-all">@reactbytes insert ripple</span>
              <Cpu size={18} className="text-[#e6dff1]/40" />
            </>
          )}
        </div>
      </div>

      <div className="flex items-center justify-between font-mono text-[11px] text-[#e6dff1]/30 border-t border-white/5 pt-3 uppercase">
...
const CodePanel: React.FC = () => {
  return (
    <div className="font-mono text-sm md:text-base leading-loose text-[#e6dff1]/60 w-full h-full flex flex-col justify-center px-4 overflow-hidden select-text bg-transparent">
      <div>
        <span className="text-blue-400">import</span>{" "}
        <span className="text-[#f2eee9]">React, &#123; useState &#125;</span>{" "}
        <span className="text-blue-400">from</span>{" "}
        <span className="text-emerald-400">&quot;react&quot;</span>;
      </div>
      <div>
        <span className="text-blue-400">import</span>{" "}
        <span className="text-[#f2eee9]">&#123; motion &#125;</span>{" "}
        <span className="text-blue-400">from</span>{" "}
        <span className="text-emerald-400">&quot;framer-motion&quot;</span>;
      </div>
      <div className="mt-4 text-[#e6dff1]/30">// Solid minimal configuration</div>
      <div>
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between py-3 px-3 bg-transparent">
      ...
      <div className="flex gap-4 items-center flex-grow py-4 px-1">
        <div className="font-mono text-[13px] text-[#e6dff1]/80 leading-normal w-2/3 flex flex-col gap-2 select-text">
          <div className="text-[#e6dff1]/30">// Custom styling ready</div>
          <div>
        ...
        <div className="w-1/3 flex flex-col items-center justify-center gap-3 bg-[#181a1e]/40 border border-white/5 rounded-xl p-4 h-28 relative overflow-hidden">
          ...
          <span className="font-mono text-[9px] text-[#e6dff1]/50 uppercase tracking-widest text-center">
            {copied ? "Copied!" : "Copy Code"}
          </span>
        </div>
      </div>

      <div className="grid grid-cols-2 gap-4 text-[11px] font-mono text-[#e6dff1]/30 border-t border-white/5 pt-3 uppercase">
...
const TestCombinationsPanel: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between py-3 px-3 bg-transparent">
      ...
      <div className="flex flex-col justify-center gap-6 flex-grow py-3 px-1">
        <div className="flex flex-col gap-1.5">
          <div className="flex justify-between font-mono text-[13px]">
            <span className="text-[#e6dff1]/50">speed</span>
            <span className="text-white font-bold">{speed}s</span>
          </div>
          <div className="w-full h-2 bg-[#181a1e]/20 border border-white/5 rounded-full overflow-hidden">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex justify-between font-mono text-[13px]">
            <span className="text-[#e6dff1]/50">glowIntensity</span>
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex justify-between font-mono text-[13px]">
            <span className="text-[#e6dff1]/50">zoomFactor</span>
      ...
      <div className="w-full bg-[#181a1e]/40 rounded-lg p-3 border border-white/5 font-mono text-xs text-[#e6dff1]/50 flex justify-between items-center overflow-x-auto whitespace-nowrap">
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center flex-grow py-4 relative">
        <div className={`w-36 h-36 rounded-full bg-gradient-to-tr from-[#c0dedd]/20 via-[#e6dff1]/30 to-[#060010] border border-white/10 flex items-center justify-center transition-all duration-700 relative group shadow-[0_0_40px_rgba(192,222,221,0.15)] ${hovered ? "scale-110" : "scale-100"}`}>
          ...
          <div className="absolute inset-8 rounded-full bg-[#0b0518] border border-white/5 flex items-center justify-center">
...
export const BentoShowcaseSection: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="production-ready"
      className="relative w-full z-20 border-t border-white/5 bg-[#060010] md:h-screen flex flex-col justify-between py-12 md:py-16 px-6 md:px-16 overflow-hidden"
    >
      ...
      <div className="hidden md:flex flex-col h-full justify-between w-full relative">
        <div className="absolute -top-4 left-0 text-[#e6dff1]/20 font-mono text-[9px] tracking-widest select-none pointer-events-none">SYS.PLAYGROUND_01</div>
        <div className="absolute -top-4 right-0 text-[#e6dff1]/20 font-mono text-[9px] tracking-widest select-none pointer-events-none">SANDBOX_ACTIVE</div>

        {/* Scaled Header */}
        <div ref={titleRef} className="max-w-2xl z-20 flex flex-col gap-4 relative mt-4 select-none">
          <div className="inline-flex items-center gap-2 text-[10px] uppercase font-mono tracking-widest text-[#c0dedd]">
        ...
        <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none z-0">
          <div className="scroll-text-el absolute font-mono font-bold text-[12vw] tracking-tighter uppercase text-white select-none whitespace-nowrap text-center translate-y-16 opacity-0">
            EXPLORE PLAYGROUND
          </div>
          <div className="scroll-text-el absolute font-mono font-bold text-[12vw] tracking-tighter uppercase text-white select-none whitespace-nowrap text-center opacity-0 translate-y-16">
            ADJUST CONTROLS
          </div>
          <div className="scroll-text-el absolute font-mono font-bold text-[12vw] tracking-tighter uppercase text-white select-none whitespace-nowrap text-center opacity-0 translate-y-16">
            COPY JSX CODE
        ...
        <div className="flex items-center justify-center [perspective:2000px] w-full h-[60vh] relative z-10 my-auto">
          ...
          >
            ...
            <div className="layer-el absolute inset-0 flex items-center justify-center will-change-transform">
              <GlowCard className="w-full h-full" borderWidth={3} baseColor="#0b0518" borderRadius="1rem" padding="0">
            ...
            <div className="layer-el absolute inset-0 flex items-center justify-center will-change-transform">
              <GlowCard className="w-full h-full" borderWidth={3} baseColor="#0b0518" borderRadius="1rem" padding="0">
                <div className="p-3 flex flex-col justify-between w-full h-full">
                  <div className="flex items-center justify-between text-sm font-mono text-[#e6dff1]/70 border-b border-white/5 pb-3">
        ...
        <div className="flex justify-between items-center text-xs font-mono text-[#e6dff1]/20 relative z-10 uppercase tracking-widest select-none mb-4">
          <div className="flex items-center gap-2">
            <Tv size={14} />
      ...
      <div className="flex md:hidden flex-col gap-12 py-12 relative w-full">
        <div className="flex flex-col gap-4 max-w-xl">
          <span className="text-[10px] font-mono text-[#c0dedd] uppercase tracking-widest">How to get our components</span>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-white font-mono uppercase">Test, Copy & Ship</h2>
          <p className="text-xs md:text-sm text-[#e6dff1]/50 leading-relaxed font-light font-sans">
        ...
        <div className="flex flex-col gap-10 w-full">
          <div className="flex flex-col gap-4">
            ...
            <GlowCard className="shadow-2xl h-[320px] w-full" borderWidth={1} baseColor="#0b0518" borderRadius="1rem" padding="0">
              <div className="p-3 flex flex-col justify-between w-full h-full">
                <LivePreviewPanel />
              </div>
            </GlowCard>

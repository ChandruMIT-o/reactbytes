...
export const HeroSection: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Blueprint Scanner Sweep Beam */}
      <motion.div 
        className="absolute left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#c0dedd]/25 to-transparent pointer-events-none"
        style={{ zIndex: 1 }}
        animate={{ y: ["0vh", "100vh"] }}

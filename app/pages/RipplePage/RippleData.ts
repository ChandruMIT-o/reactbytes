export const loaderProps = [
  ...
  {
    title: "Styling & Children Props",
    props: [
      {
        name: "colorBase",
        type: "[number, number, number]",
        defaultValue: "[0.15, 0.45, 1.0]",
        description: "Base color vector (normalized [R, G, B]) used to tint the shader wave color.",
      },
      {
        name: "className",
        type: "string",
      ...
      },
      {
        ...
        description: "Content rendered inside the relative overlay container on top of the background.",
      },
    ],
  },
];

...
export const componentCode = `import React, { useState, useEffect, useRef, useMemo } from 'react';
...
const PRESETS = [
    {
        id: "default",
        label: "Default",
        config: { zGap: 600, speedFactor: 2.5, lerpFactor: 0.08, warpFactor: 2.0, basePerspective: 800, enableSnap: false }
    },
    {
        id: "snappy",
        label: "Snappy",
        config: { zGap: 800, speedFactor: 3.0, lerpFactor: 0.1, warpFactor: 1.5, basePerspective: 600, enableSnap: true }
    },
    {
        id: "warp",
        label: "Warp Speed",
        config: { zGap: 1200, speedFactor: 5.0, lerpFactor: 0.05, warpFactor: 4.0, basePerspective: 1000, enableSnap: false }
    },
    {
        id: "smooth",
        label: "Smooth Float",
        config: { zGap: 400, speedFactor: 1.5, lerpFactor: 0.02, warpFactor: 0.5, basePerspective: 1200, enableSnap: false }
    },
    {
        id: "tight",
        label: "Tight Tunnel",
        config: { zGap: 300, speedFactor: 2.0, lerpFactor: 0.1, warpFactor: 1.0, basePerspective: 400, enableSnap: true }
    }
];
...
export const VoidCarouselProps: PropDefinition[] = [
    { name: "items", type: "CarouselItem[]", defaultValue: "[]", description: "Array of items to display." },
    { name: "zGap", type: "number", defaultValue: "600", description: "Distance between items in Z space." },
    { name: "speedFactor", type: "number", defaultValue: "2.5", description: "Scroll speed multiplier." },
    { name: "lerpFactor", type: "number", defaultValue: "0.08", description: "Lerp momentum factor." },
    { name: "warpFactor", type: "number", defaultValue: "2.0", description: "Warp effect intensity." },
    { name: "basePerspective", type: "number", defaultValue: "800", description: "Base 3D perspective." },
    { name: "enableSnap", type: "boolean", defaultValue: "false", description: "Enable magnetic snapping." },
    { name: "activeZ", type: "number", defaultValue: "0", description: "Z position where items focus and snap." },
    { name: "opacityFade", type: "number", defaultValue: "400", description: "Distance over which items fade out past activeZ." },
];
...
export const creditsData = [
    {
        title: "Developer",
        items: [{ name: "React Bytes", role: "Component Creation", url: "https://github.com/ChandruMIT-o" }]
    }
];

export const DEFAULT_ITEMS = [
    { id: '1', type: 'text' as const, content: 'SYSTEM' },
    { id: '2', type: 'image' as const, content: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop', title: 'NEURAL NET', subtitle: 'v2.0.4' },
    ...
    { id: '5', type: 'image' as const, content: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=800&auto=format&fit=crop', title: 'CYBER CORE', subtitle: 'Online' },

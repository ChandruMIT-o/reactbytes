    ...
    props: [
      {
        ...
        description: "Optional foreground UI content to overlay on top of the drift animation.",
      },
      {
        name: "showGrid",
        type: "boolean",
      ...
      {
        name: "preset",
        type: '"mistral" | "sirocco" | "aurora" | "storm" | "zen"',
        defaultValue: '"mistral"',
        description: "Active wind preset determining flow configurations.",
      },
      {
        name: "palette",
        type: '"midnight" | "aurora" | "sirocco" | "volcanic" | "monochrome"',
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        description: "Custom CSS wrapper classes to handle sizes and border styles.",
      },
    ],
  },
];
...
export const componentCode = `/* eslint-disable @typescript-eslint/no-unused-vars */
"use client";

export const loaderProps = [
  {
    title: "ConcentricWaves Properties",
    props: [
      { name: "layerCount", type: "number", defaultValue: "16", description: "Number of concentric ring layers." },
      { name: "ringSpacing", type: "number", defaultValue: "45", description: "Distance between each main ring." },
      { name: "baseRadiusStart", type: "number", defaultValue: "40", description: "Starting radius of the innermost ring." },
      { name: "pulseSpeedMultiplier", type: "number", defaultValue: "1", description: "Multiplier for how fast the rings pulse inwards/outwards." },
      { name: "spinDurationMs", type: "number", defaultValue: "2500", description: "How long it takes for the gradient to complete a 360 rotation (in ms)." },
      { name: "mainGradientColors", type: "[string, string, string]", defaultValue: "['#5ddcff', '#3c67e3', '#4e00c2']", description: "Tuple of 3 colors for the main thick rings." },
      { name: "midGradientColors", type: "[string, string, string]", defaultValue: "['#f3f4f6', '#9ca3af', '#374151']", description: "Tuple of 3 colors for the intermediate thin grayscale rings." },
      { name: "minOpacity", type: "number", defaultValue: "0.4", description: "Minimum opacity for the main rings during their pulse." },
      { name: "maxOpacity", type: "number", defaultValue: "0.9", description: "Maximum opacity for the main rings during their pulse." },
      { name: "minThickness", type: "number", defaultValue: "4", description: "Thickness of the innermost main ring." },
      { name: "maxThickness", type: "number", defaultValue: "16", description: "Thickness of the outermost main ring." },
      { name: "bgColor", type: "string", defaultValue: "'#05080f'", description: "Background color of the canvas." },

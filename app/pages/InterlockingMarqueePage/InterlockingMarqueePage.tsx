...
import { InterlockingMarquee } from "../../meta/marquee/InterlockingMarquee/InterlockingMarquee";
import { loaderProps, componentCode, creditsData } from "./InterlockingMarqueeData";
...
// --- Default SVG Assets for Preview ---
const SVGS = {
    McDonalds: () => (
...
const DEFAULT_LOGOS = [
    <SVGS.McDonalds key="mcd" />,
    <SVGS.Jordan key="jordan" />,
    <SVGS.AWS key="aws" />,
    <SVGS.Spotify key="spotify" />,
    <SVGS.BurgerKing key="bk" />,
    <SVGS.Honda key="honda" />,
    <SVGS.Notion key="notion" />,
    <SVGS.Hulu key="hulu" />,
];
...
const variantOptions = [
    { id: "classic", label: "Classic Jigsaw" },
    { id: "curvy", label: "Curvy Organic" },
    { id: "wave", label: "Wave Pattern" },
    { id: "hex", label: "Hex Lock" },
];

export const InterlockingMarqueePage = () => {
    const [duration, setDuration] = useState(30000);
    const [reverse, setReverse] = useState(false);
    const [pauseOnHover, setPauseOnHover] = useState(true);
    const [variant, setVariant] = useState<any>("classic");
    ...
    const applyPreset = (presetId: string) => {
        ...
        if (preset) {
            ...
            setReverse(preset.config.reverse);
            setPauseOnHover(preset.config.pauseOnHover);
            setVariant(preset.config.variant || "classic");
            setKey((prev) => prev + 1);
        }
    };
    ...
    const usageCode = `<InterlockingMarquee
  items={[/* your logos */]}
  variant="${variant}"
  duration={${duration}}
  reverse={${reverse}}
...
/>`;
    ...
    return (
        <div className="flex flex-col gap-5">
            <div id="interlocking-marquee-title">
                <HeaderText text="Interlocking Marquee" option={3} />
            </div>
            <ParagraphText
                text="An infinite scrolling marquee featuring a unique interlocking jigsaw geometry. Perfect for showcasing partner logos or feature highlights with a premium, tactile feel."
                option={4}
            />
            ...
            <div id="preview">
                <PreviewTab
                    previewContent={
                        <div className="w-full h-[400px] relative overflow-hidden flex flex-col items-center justify-center p-10 bg-[#060010]">
                            {/* Background Pattern */}
                            <div className="absolute inset-0 bg-[radial-gradient(#1D1C21_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none opacity-80" />
                            ...
                            {/* Show a second one for the 'interlocking' effect demo */}
                            <InterlockingMarquee
                                key={`rev-${key}`}
                                items={[...DEFAULT_LOGOS].reverse()}
                                variant={variant}
...
export default InterlockingMarqueePage;

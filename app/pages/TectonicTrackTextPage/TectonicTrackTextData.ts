		...
		props: [
			{
				...
				description: "The typography string to mount to the elastic track.",
			},
			{
				name: "fontSize",
				type: "number",
				defaultValue: "75",
				description: "Scale of font size in pixels (dynamically sizes container bounds).",
			},
			{
				name: "maxTrackingExpansion",
				type: "number",
				defaultValue: "35",
				description: "Maximal added spacing pixel padding injected per character at peak hover.",
			},
			{
				name: "maxScaleX",
				type: "number",
				defaultValue: "1.25",
				description: "Scale factor increasing character width matrix when active.",
			},
			{
				name: "influenceRadius",
				type: "number",
				defaultValue: "120",
				description: "Proximity boundary radius for cursor interaction (in pixels).",
			},
			{
				name: "stiffness",
				type: "number",
				defaultValue: "0.08",
				description: "Spring tension tracking speed index.",
			},
			{
				name: "damping",
				type: "number",
				defaultValue: "0.74",
				description: "Friction coefficient slowing tracking oscillations.",
			},
		],
	},
	{
		...
		props: [
			...
			},
			{
				...
				description: "Color of the minimalist micro-metric baseline rules.",
			},
			{
				name: "className",
				type: "string",
				defaultValue: "''",
				description: "Extra wrapper layout container custom CSS classes.",
			},
		],
	},
];

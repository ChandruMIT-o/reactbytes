export const loaderProps = [
  {
    title: "EndlessMotionFooter Properties",
    props: [
      {
        name: "text",
        type: "string",
      ...
      {
        name: "mode",
        type: '"internal" | "page-footer"',
        defaultValue: '"internal"',
        description: "The scroll behavior mode. 'internal' sets self-contained scrolling in the container, while 'page-footer' hooks into the page/ancestor scroll-container to gate scroll-down at the bottom into endless text translation."
      },
      {
        name: "scroller",
        type: "string | HTMLElement",
        defaultValue: "undefined",
        description: "Custom scroller container for ScrollTrigger (defaults to the internal container)."
      },
      {
        name: "autoScroll",
        type: "boolean",
      ...
      },
      {
        ...
        type: "string",
        defaultValue: '""',
        description: "Additional CSS classes to apply to the root wrapper element."
      }
    ]
  }
];

export const creditsData: any[] = [];

export const componentCode = `import React, { useEffect, useLayoutEffect, useRef, useState } from 'react';

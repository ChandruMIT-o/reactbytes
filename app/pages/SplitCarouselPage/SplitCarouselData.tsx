...
export const componentCode = `import React, { useEffect, useRef, useState, useCallback } from 'react';
        ...
        >
            <div className="slider-card-inner w-full relative">
                ...
                <div className={\`absolute -bottom-10 left-1/2 -translate-x-1/2 transition-opacity duration-500 \${progress > 0 ? 'opacity-0' : 'opacity-100'}\`}>
                    <p className="text-[10px] uppercase tracking-[0.3em] text-zinc-500 animate-pulse whitespace-nowrap">Hover & Scroll</p>
                </div>
            </div>
        </div>
    );
...
export const splitCarouselProps: PropDefinition[] = [
    {
        name: "leftImages",
        type: "string[]",
        defaultValue: "DEFAULT_LEFT_IMAGES",
        description: "Array of image URLs for the left side of the carousel."
    },
    {
        name: "rightImages",
        type: "string[]",
        defaultValue: "DEFAULT_RIGHT_IMAGES",
        description: "Array of image URLs for the right side of the carousel."
    },
    {
        name: "sensitivity",
        type: "number",
    ...
    },
    {
        ...
        type: "string",
        defaultValue: "'20vw'",
        description: "The width of each image card."
    },
    {
        name: "imageMinHeight",
        type: "string",
        defaultValue: "'350px'",
        description: "The minimum height of the image cards."
    },
    {
        name: "borderRadius",
        type: "string",
        defaultValue: "'0.75rem'",
        description: "The border radius applied to the inner corners of the split images."
    }
];

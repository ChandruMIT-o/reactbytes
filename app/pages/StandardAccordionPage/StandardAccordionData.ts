...
export const defaultAccordionData: AccordionItemData[] = [
    {
        id: "item-1",
...
const AccordionItem: React.FC<AccordionItemProps> = ({
    ...
    return (
        <motion.div
            ...
            className="relative border border-white/10 -mt-[1px] first:mt-0 overflow-hidden group cursor-pointer"
            onClick={onClick}
        >
            <div
                className="w-full flex items-center gap-4 p-5 text-left focus:outline-none relative overflow-hidden"
            >
                <div 
                ...
                <svg
                    className="w-5 h-5 flex-shrink-0 opacity-70 relative z-10"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                ...
                <span 
                    className="flex-1 relative z-10 font-sans tracking-tight font-medium"
                    style={{ color: titleColor }}
                >

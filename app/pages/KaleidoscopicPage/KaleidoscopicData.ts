export const loaderProps = [
  {
    title: "Kaleidoscopic Properties",
    props: [
      { name: "className", type: "string", defaultValue: "''", description: "Additional CSS classes for the canvas element." },
      { name: "iterations", type: "number", defaultValue: "4", description: "Number of domain folding iterations (detail level)." },
      { name: "timeMultiplier", type: "number", defaultValue: "1.0", description: "Speed multiplier for the animation." },
      { name: "rotationSpeed", type: "number", defaultValue: "0.05", description: "Speed of the overall rotation." },
      { name: "scale", type: "number", defaultValue: "1.3", description: "Scale factor for the space fold." },
      { name: "colorA", type: "[number, number, number]", defaultValue: "[0.5, 0.5, 0.5]", description: "Palette color A (RGB 0-1)." },
      { name: "colorB", type: "[number, number, number]", defaultValue: "[0.5, 0.5, 0.5]", description: "Palette color B (RGB 0-1)." },
      { name: "colorC", type: "[number, number, number]", defaultValue: "[1.0, 1.0, 1.0]", description: "Palette color C (RGB 0-1)." },
      { name: "colorD", type: "[number, number, number]", defaultValue: "[0.263, 0.416, 0.557]", description: "Palette color D (RGB 0-1)." },
      { name: "glowIntensity", type: "number", defaultValue: "0.012", description: "Base intensity of the glow effect." },
      { name: "glowPower", type: "number", defaultValue: "1.2", description: "Exponent for the glow falloff." },
      { name: "waveFrequency", type: "number", defaultValue: "8.0", description: "Frequency of the sine wave modulation." },
      { name: "waveAmplitude", type: "number", defaultValue: "8.0", description: "Amplitude divisor for the wave." },
      { name: "vignetteStart", type: "number", defaultValue: "0.5", description: "Starting radius for the vignette." },
      { name: "vignetteEnd", type: "number", defaultValue: "3.0", description: "Ending radius for the vignette." },
    ],
  },
];

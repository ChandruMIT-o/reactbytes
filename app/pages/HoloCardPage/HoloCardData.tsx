...
export const HoloCardProps = [
    {
        name: "image",
        type: "string",
        defaultValue: "Unsplash URL",
    ...
    },
    {
        ...
        type: "string",
        defaultValue: '"linear"',
        description: "The pattern type for the holographic effect ('linear' | 'radial' | 'hexagonal').",
    },
    {
        name: "holoIntensity",
        type: "number",
    ...
    },
    {
        ...
        type: "number",
        defaultValue: "133",
        description: "Rotation angle for the holographic light bands (in degrees).",
    },
    {
        name: "tiltSpread",
        type: "number",

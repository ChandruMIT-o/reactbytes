...
import { glowCardProps, componentCode, creditsData } from "./GlowCardData";
...
>
  <div className="flex flex-col items-center">
    <span className="text-2xl font-bold bg-white/10 px-3 py-1 rounded">HOUDINI</span>
    <p className="mt-2 text-sm opacity-50">Custom Content</p>
  </div>
</GlowCard>`;
			...
			<div id="preview">
                                ...
                                >
                                    <div className="flex flex-col items-center pointer-events-none">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-white text-lg font-black tracking-widest uppercase">Glow Card</span>
                                        </div>
				...
				>
                    ...
                    <div className="space-y-6">
                        <div className="text-[10px] uppercase tracking-widest text-rb-accent-1 opacity-50 font-bold border-b border-white/5 pb-2">Movement</div>
                        <DiscreteSlider
                            label="Orbit Speed"
                            min={0.5}
                            max={10.0}
                    ...
                    {/* Optics */}
                    <div className="space-y-6">
                        <div className="text-[10px] uppercase tracking-widest text-rb-accent-1 opacity-50 font-bold border-b border-white/5 pb-2">Optics</div>
                        <DiscreteSlider
                            label="Bloom Opacity"
                            min={0.0}
                            max={1.0}
                    ...
                    {/* Geometry */}
                    <div className="space-y-6">
                        <div className="text-[10px] uppercase tracking-widest text-rb-accent-1 opacity-50 font-bold border-b border-white/5 pb-2">Geometry</div>
                        <DiscreteSlider
                            label="Border Width"
                            min={1}
                            max={10}
                        ...
                        <ColorPicker
                            ...
                            compact={true}
                            presets={["hsl(260deg 100% 3%)", "hsl(120deg 100% 5%)", "hsl(200deg 100% 2%)", "#000000"]}
                        />
                    </div>
                </PreviewTab>
			</div>

export const loaderProps = [
  {
    title: "Main Options",
    props: [
      { name: "title", type: "string", defaultValue: "'An awesome title'", description: "The title text to display in the center." },
      { name: "switchText", type: "string", defaultValue: "'switch bg'", description: "The text for the switch label." },
      { name: "stripeColor", type: "string", defaultValue: "'#fff'", description: "The color of the stripes (hex or CSS color)." },
      { name: "bgColor", type: "string", defaultValue: "undefined", description: "The background color. Defaults to stripeColor if not provided." },
      { name: "checked", type: "boolean", defaultValue: "undefined", description: "Whether the dark mode is active (controlled)." },
      { name: "onCheckedChange", type: "(checked: boolean) => void", defaultValue: "undefined", description: "Callback when the switch is toggled." },
      { name: "initialChecked", type: "boolean", defaultValue: "false", description: "Whether the dark mode is initially active (uncontrolled)." },
      { name: "className", type: "string", defaultValue: "''", description: "Optional className for the container." },
    ],
  },
];
...
export const creditsData = [
  {
    ...
    items: [
      { name: "Paco Coursey", role: "Original Concept", url: "https://paco.me/" },
      { name: "ReactBytes", role: "Implementation", url: "https://reactbytes.com" },
    ],
  },
];

export const componentCode = `import React, { useState } from 'react';

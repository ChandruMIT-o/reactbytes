    ...
    props: [
      {
        ...
        description: "Optional foreground UI content to overlay on top of the stripe wave background.",
      },
      {
        name: "seed",
        type: "number",
...
const FRAGMENT_SHADER = \\\`
  ...
  float cnoise(vec3 P){
      ...
      vec3 g001 = vec3(gx1.x,gz1.x,gz1.x);

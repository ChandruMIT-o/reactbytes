...
export const loaderProps = [
    {
        ...
        props: [
            {
                name: "items",
                type: "DitherCarouselItem[]",
                defaultValue: "DEFAULT_ITEMS",
                description: "Array of carousel slide items with id, title, subtitle, photographer, desc, and url."
            },
            {
                name: "autoPlay",
                type: "boolean",
    ...
    {
        title: "Dither & Color Controls",
        props: [
            {
                name: "ditherResolution",
                type: "'retro' | 'medium' | 'high'",
                defaultValue: "'medium'",
                description: "Resolution of the dither canvas buffer. 'retro' is broad density (320px wide), 'medium' is 480px, 'high' is fine density (800px)."
            },
            {
                name: "colorMode",
                type: "'color' | 'mono' | 'cyberpunk' | 'gameboy' | 'amber' | 'champagne' | 'nordic' | 'rose' | 'emerald'",
                defaultValue: "'champagne'",
                description: "The visual style and palette applied to the dither shader: color (original 16-bit dithered), mono (1-bit high contrast), or custom luxury/retro duotones."
            },
            {
        ...
        props: [
            {
                ...
                type: "string | number",
                defaultValue: "'480px'",
                description: "The height of the carousel container (e.g. '480px' or 500)."
            },
            {
                name: "className",
                type: "string",
...
export const componentCode = `import React, { useState, useEffect, useRef, useCallback } from 'react';
import {
    ChevronLeft,
    ChevronRight,
    Sparkles

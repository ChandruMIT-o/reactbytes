	...
	},
	{
		...
		props: [
			...
			},
			{
				...
				type: "string",
				defaultValue: "'rgba(0, 245, 255, 0.45)'",
				description: "Color of the ribbon/string when dragging.",
			},
			{
				name: "strokeColor",
				type: "string",
				defaultValue: "'rgba(255, 255, 255, 0.08)'",
				description: "Color of the ribbon/string when idle.",
			},
			{
				name: "activeCrosshairColor",
				type: "string",
				defaultValue: "'rgba(255, 0, 110, 0.25)'",
				description: "Color of the anchor home crosshair indicator when dragging.",
			},
			{
				name: "className",
				type: "string",
				defaultValue: "''",
				description: "Extra CSS class names for the canvas wrapper.",
			},
		],
	},
];
